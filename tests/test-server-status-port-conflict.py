...
"""
Test that ghostunnel server exits with an error when the --status port is
...
try:
    ...
    # start ghostunnel; it should fail because the status port is taken
    ...
    try:
        ...
        # ConnectionRefusedError is the expected path; OSError covers
