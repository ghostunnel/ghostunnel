...
if __name__ == "__main__":
  ...
  try:
    ...
    try:
      ...
      raise Exception('rejected unauthenticated client2, despite --disable-authentication')
    ...
    try:
      ...
      raise Exception('rejected authenticated other_client1, despite --disable-authentication')
