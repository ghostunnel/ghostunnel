...
if __name__ == "__main__":
  ...
  try:
    ...
    pair = SocketPair(TcpClient(13001), TlsServer('server1', 'root', 13002, cert_reqs=ssl.CERT_NONE))
    ...
    try:
      pair = SocketPair(TcpClient(13001), TlsServer('other_server', 'other_root', 13002, cert_reqs=ssl.CERT_NONE))
    ...
    try:
      pair = SocketPair(TcpClient(13001), TlsServer('server2', 'root', 13002, cert_reqs=ssl.CERT_NONE))
