...
// the figure comparable to docs/bench/baseline.txt.
...
// isolates the per-connection metric-bookkeeping cost that Finding 12 removes
...
// to see the timer contention (see the analysis doc's benchmark caveats).
...
// actually resolves Finding 12: the metrics=live column records to real
